...
public class IconsObj {
    public int ic_start_record = R.drawable.ic_start_record;
    public int ic_stop_play = R.drawable.ic_stop_play;
    public int ic_play_record = R.drawable.ic_play_record;
    public int ic_audio_delete = R.drawable.ic_audio_delete;
    public int ic_send_circle = R.drawable.ic_send_circle;
    public int ic_stop_record = R.drawable.ic_stop_record;
