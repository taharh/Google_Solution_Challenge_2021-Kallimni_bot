...
public class LangObj {
    ...
    public String record_audio_string = "Start Record";
    public String hold_for_record_string = "Hold for record";
    public String release_for_end_string = "Release for end record";
    public String listen_record_string = "You can listen record";
    public String stop_listen_record_string = "Stop Listen";
    public String stop_record_string = "Stop Record";
    public String send_record_string = "Send Record";
